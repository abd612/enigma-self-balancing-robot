...
/**
 * @brief  Using Digital Low Pass Filter to get filtered output.
 */
typedef enum {
	BK_MPU6050_BW_Acc_260_Gyro_256 = 0x00,
	BK_MPU6050_BW_Acc_184_Gyro_188 = 0x01,
	BK_MPU6050_BW_Acc_94_Gyro_98 = 0x02,
	BK_MPU6050_BW_Acc_44_Gyro_42 = 0x03,
	BK_MPU6050_BW_Acc_21_Gyro_20 = 0x04,
	BK_MPU6050_BW_Acc_10_Gyro_10 = 0x05,
	BK_MPU6050_BW_Acc_5_Gyro_5 = 0x06
} BK_MPU6050_DLPF_t;
...
/**
 * @brief  Activates Digital Low Pass Filter at desired Bandwidth
 * @param  *DataStruct: Pointer to @ref TM_MPU6050_t structure to store data to
 * @param  BK_MPU6050_DLPF_t: Desired Bandwidth
 * @retval Member of @ref TM_MPU6050_Result_t:
 *            - TM_MPU6050_Result_Ok: everything is OK
 *            - Other: in other cases
 */
TM_MPU6050_Result_t BK_MPU6050_Activate_DLPF(TM_MPU6050_t* DataStruct, BK_MPU6050_DLPF_t Bandwidth);
TM_MPU6050_Result_t BK_MPU6050_Activate_DLPF_Custom(TM_MPU6050_Custom_t* DataStruct, BK_MPU6050_DLPF_t Bandwidth);

TM_MPU6050_Result_t BK_MPU6050_Configure_INT(TM_MPU6050_t* DataStruct);
